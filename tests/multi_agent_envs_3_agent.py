...
def create_multiagent_env():
    ...
    #    reload_list.append(item)
    e = SynchronousMultiAgentEnv(num_agents=num_agents, grid_size=[gridsize, gridsize], capacities=[100000 for _ in range(num_agents)], reloads=reload_list,
...
if __name__ == "__main__":
    ...
    #     reload_list.append(item)
    print(reload_list)
    env = SynchronousMultiAgentEnv(num_agents=num_agents, grid_size=[gridsize, gridsize], capacities=[400 for _ in range(num_agents)], reloads=reload_list,
                                 targets=targets, init_states=init_state,
